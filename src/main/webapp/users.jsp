...
<div class="navbar">
    ...
    <div class="nav-links">
        <a href="${pageContext.request.contextPath}/users" class="nav-link active">
...
<div class="container">
    <div class="page-header">
        <h1 class="page-title"><i class="fas fa-users"></i> Пользователи</h1>
        <a href="${pageContext.request.contextPath}/users?action=add" class="btn btn-success">
    ...
    <ul class="pagination">
        <% int currentPage = (Integer) request.getAttribute("currentPage");
            ...
            if (currentPage > 1) { %>
        <li class="page-item">
            <a href="${pageContext.request.contextPath}/users?page=<%= currentPage-1 %>" class="page-link">
