...
<head>
    ...
    <script>
        function confirmDelete() {
            return confirm('Вы уверены, что хотите удалить этот трек?');
        }
    </script>
</head>
<body>
<div class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="${pageContext.request.contextPath}/tracks" class="nav-link active">
            <i class="fas fa-music"></i> Треки
        </a>
        <a href="${pageContext.request.contextPath}/playlists" class="nav-link">
...
<div class="container">
    <div class="page-header">
        <h1 class="page-title"><i class="fas fa-music"></i> Треки</h1>
        <a href="${pageContext.request.contextPath}/tracks?action=add" class="btn btn-success">
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="${pageContext.request.contextPath}/tracks?action=edit&id=<%= track.getId() %>"
    ...
    <ul class="pagination">
        <% int currentPage = (Integer) request.getAttribute("currentPage");
            ...
            if (currentPage > 1) { %>
        <li class="page-item">
            <a href="${pageContext.request.contextPath}/tracks?page=<%= currentPage-1 %>" class="page-link">
        ...
        <li class="page-item">
            <a href="${pageContext.request.contextPath}/tracks?page=<%= i %>"
